...
export function cleanOutput(race) {
    return {
        ...race,
        id: undefined,
...
export function getChampionsMeetingByScope(scope = 'current') {
...
export function findChampionsMeetingByName(name, { upcomingOnly = false } = {}) {
