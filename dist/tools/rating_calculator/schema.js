...
const describeAptitude = (aptitude) => `Rank for ${aptitude} Aptitude. Be critical about the rank letter and make sure it is correct!`;
...
export const inputSchema = z.object({
    ...
    umamusume: z.enum(Array.from(characters)).describe('Name of the Umamusume. Epithet is not a name, characters within brackets [] are not a name.'),
